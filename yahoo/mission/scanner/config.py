...
BUBBLE_ROIS_PCT = {
    q: {
        "A": (0.16, 0.25 + (q-1)*0.085, 0.055, 0.03),  # Start at 25% (below name box at 20%)
        "B": (0.31, 0.25 + (q-1)*0.085, 0.055, 0.03),
        "C": (0.46, 0.25 + (q-1)*0.085, 0.055, 0.03),
        "D": (0.61, 0.25 + (q-1)*0.085, 0.055, 0.03),
    }
    for q in range(1, 11)
}
